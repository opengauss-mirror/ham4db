...
function mysqlNormalizeInstance(instance) {
...
function mysqlNormalizeInstanceProblem(instance) {
...
function mysqlCreateVirtualInstance(id) {
    var virtualInstance = {
        id: id,
        children: [],
        parent: null,
    ...
    mysqlNormalizeInstanceProblem(virtualInstance);
    return virtualInstance;
}

function mysqlNormalizeInstances(instances, maintenanceList) {
    if (!instances) {
        instances = [];
    }
    instances.forEach(function (instance) {
        mysqlNormalizeInstance(instance);
    });
    ...
    instances.forEach(function (instance) {
        ...
        mysqlNormalizeInstanceProblem(instance);
    });
    ...
    instances.forEach(function (instance) {
        if (instance.isMaster && instance.parent != null && instance.parent.parent != null && instance.parent.parent.id == instance.id) {
            ...
            var virtualCoMastersRoot = mysqlCreateVirtualInstance();
...
function mysqlRenderInstanceElement(popoverElement, instance, renderType) {
