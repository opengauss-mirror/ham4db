...
func NewConsulTxnStore() dtstruct.KVStore {
...
func (this *consulTxnStore) PutKVPairs(kvPairs []*dtstruct.KVPair) (err error) {
	if this.client == nil {
		return nil
	}
...
func (this *consulTxnStore) DistributePairs(kvPairs []*dtstruct.KVPair) (err error) {
