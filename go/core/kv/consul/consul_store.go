...
func NewConsulStore() dtstruct.KVStore {
	store := &consulStore{
...
func (this *consulStore) PutKVPairs(kvPairs []*dtstruct.KVPair) (err error) {
	if this.client == nil {
		return nil
	}
...
func (this *consulStore) DistributePairs(kvPairs []*dtstruct.KVPair) (err error) {
